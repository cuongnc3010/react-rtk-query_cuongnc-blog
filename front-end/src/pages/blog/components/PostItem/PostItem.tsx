      ...
      <div className='flex flex-col gap-2 p-4 lg:p-6'>
        ...
        <div>
          <div className='inline-flex rounded-md shadow-sm' role='group'>
            <a
              href='#form'
              className='rounded-l-lg border border-gray-200 bg-white py-2 px-4 text-sm font-medium text-gray-900 focus-within:z-10 focus-within:text-blue-700 focus-within:ring-2 focus-within:ring-blue-700 hover:bg-gray-100 hover:text-blue-700'
