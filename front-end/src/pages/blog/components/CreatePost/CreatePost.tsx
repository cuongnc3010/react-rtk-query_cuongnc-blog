...
import { endEditPost } from 'pages/blog/blog.slice'
...
type FormError =
  | {
      [key in keyof typeof initialState]: string //typeof initialState  = Omit<Post, 'id'>
    }
  | null
...
export default function CreatePost() {
  ...
  const errorForm: FormError = useMemo(() => {
    ...
    // mỗi kiểu lại có cấu trúc khác nhau nên chúng ta cần kiểm tra để hiển thị cho đúng
  ...
  return (
    <form id='form' onSubmit={handleSubmit} onReset={handleCancel}>
      <div className='mb-6'>
      ...
      <div className='mb-6'>
        <label
          htmlFor='publishDate'
          className={clsx('mb-2 block text-sm font-medium dark:text-gray-300', {
        ...
        <input
          type='datetime-local'
          id='publishDate'
          className={clsx('block w-56 rounded-lg border p-2.5 text-sm focus:outline-none', {
