...
/**
 * Kieu ErrorformObject danh cho truong hop tong quat
 */
 ...
 *
 * So sánh với phương pháp ép kiểu "Type Assertions" thì ép kiểu chúng giúp chúng ta đúng về mặc Type, chưa chắc đúng về logic
 *
 */
